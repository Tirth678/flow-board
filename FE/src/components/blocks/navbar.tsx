    ...
    dropdownItems: [
      {
        ...
        description: "Visualize your workflow with drag-and-drop kanban boards built for teams.",
      },
      {
        title: "Team Collaboration",
        href: "/#resource-allocation",
        description: "Assign tasks, comment, and collaborate in real-time with your team.",
      },
    ],
  },
    ...
    >
      <div className="container flex items-center justify-between h-16">
        <Link href="/" className="flex shrink-0 items-center gap-2">
          <span className="text-lg font-bold tracking-tight">Flow Board</span>
        </Link>
