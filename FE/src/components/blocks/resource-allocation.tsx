...
const topItems = [
  {
    title: "Reusable card templates.",
    description:
      "Create task templates for recurring work so your team never starts from scratch.",
    images: [
      {
        src: "/resource-allocation/templates.webp",
        alt: "Card template interface",
        width: 495,
        height: 186,
      },
    ],
  ...
  },
  {
    ...
    description: "Replace Jira, Notion, and spreadsheets with one lightweight board.",
    images: [
      ...
      { src: "/logos/monday.svg", alt: "Monday logo", width: 48, height: 48 },
      { src: "/logos/drive.svg", alt: "Google Drive logo", width: 48, height: 48 },
      { src: "/logos/jira.svg", alt: "Jira logo", width: 48, height: 48 },
...
const bottomItems = [
  {
    ...
    description:
      "Keep your boards clean by archiving done tasks while keeping history accessible.",
    images: [
      {
  ...
  {
    title: "Card comments & discussions.",
    description:
      "Keep conversations attached to tasks so context is never lost.",
    images: [
      {
        src: "/resource-allocation/discussions.webp",
        alt: "Card discussions interface",
        width: 320,
        height: 103,
      },
    ],
  ...
  },
  {
    ...
    description:
      "Get notified when tasks are assigned, updated, or nearing their deadline.",
    images: [
      {
